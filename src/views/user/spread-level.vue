    ...
    <div class="coin-user-spread">
        <div class="coin-user-spread-item">
            <div class="flex between level">
                ...
                <div><a class="btn" v-if="user.vip_level < 3" @click="handleLevelUpdate">升级</a></div>
            </div>
        </div>
        <div class="coin-user-spread-item">
            <div class="flex between level">
                ...
                <div><a class="btn" v-if="user.vip_level < 4" @click="handleLevelUpdate">升级</a></div>
            </div>
        </div>
        <div class="coin-user-spread-item">
            <div class="flex between level">
                ...
                <div><a class="btn" v-if="user.vip_level < 5"  @click="handleLevelUpdate">升级</a></div>
            </div>
        </div>
