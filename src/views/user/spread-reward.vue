...
<script>
  ...
  import { initUserSpreadReward } from '../../vuex/actions'
  export default {
    components: {
      suScroll: scroll
    },
    vuex: {
      actions: {
        initUserSpreadReward,
      },
      getters: {
          list: (state) => state.downLineLog
      }
    },
    route: {
      data () {
        this.initUserSpreadReward()
      }
    }
  }
</script>